...
const routes = [
  ...
  //adicionar novas rotas para os componentes de Specialists
  {
    path: "/admin/specialist",
    name: "listSpecialists",
    component: () => import("@/views/specialist/ListSpecialist.vue")
  },
  {
    path: "/admin/specialist/:specialistId",
    name: "editSpecialist",
    component: () => import("@/views/specialist/EditSpecialist.vue")
  },
  {
    path: "/admin/specialist/add",
    name: "addSpecialist",
    component: () => import("@/views/specialist/AddSpecialist.vue")
  },
  //adicionar novas rotas para os componentes de Sponsors
  {
    path: "/admin/sponsor",
    name: "listSponsors",
